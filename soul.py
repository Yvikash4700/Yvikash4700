...
TOKEN = '7761675538:AAEvCOPGOT6Hdugz-Ym8okixwrzk9RNeqaw'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002472860531
CHANNEL_ID = -1002472860531
error_channel_id = -1002472860531
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/cocog470*", parse_mode='Markdown')
